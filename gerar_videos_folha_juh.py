...
def colocar_mao(img, box, progresso):
    ...
    # ponta do marcador dentro do PNG
    tip_offset_x = 34
    tip_offset_y = 26
    ...
    # Faz a mão entrar pela direita e por baixo,
    # deixando o corte acontecer fora da tela de forma natural.
    min_x = W - int(mao.width * 0.58)
    if hand_x < min_x:
        hand_x = min_x

    min_y = H - int(mao.height * 0.76)
    if hand_y < min_y:
        hand_y = min_y
